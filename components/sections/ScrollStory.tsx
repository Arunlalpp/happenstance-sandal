...
export function ScrollStory() {
    ...
    const onProgress = useCallback((p: number) => {
        ...
        if (tcRef.current) {
            ...
            tcRef.current.textContent = `${(p * dur).toFixed(1)}s`;
        }
    }, []);
            ...
            <section id="scene" className="relative h-[100svh] w-full overflow-hidden bg-ink">
                ...
                <div className="pointer-events-none absolute inset-0 z-10 mx-auto flex max-w-[1600px] flex-col justify-center px-6 md:px-10">
                    ...
                    <p className="mt-6 max-w-sm text-dune">
                        Every pair is boxed by hand before it reaches you.
                    </p>
                </div>
            </section>
        );
            ...
            <div className="sticky top-0 h-[100svh] w-full overflow-hidden">
                ...
                {BEATS.map((beat, i) => (
                    ...
                    >
                        ...
                        <h2 className="mt-4 max-w-xl font-display text-fluid-lg leading-[0.9] text-sand">
                            {beat.title}
                        </h2>
                ...
                <div className="pointer-events-none absolute inset-x-6 bottom-8 z-10 mx-auto flex max-w-[1600px] items-center gap-3 font-mono text-[11px] uppercase tracking-label text-dune md:inset-x-10">
                    ...
                    <span className="whitespace-nowrap">Scroll to unfold</span>
                </div>
            </div>
        </section>
    );
