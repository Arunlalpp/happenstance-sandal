            ...
            <div className="mx-auto max-w-[1600px]">
                ...
                <div className="mt-16 flex flex-col justify-between gap-10 border-t border-sand/10 pt-10 md:flex-row">
                    <div className="max-w-sm">
                        ...
                        <form
                            className="mt-6 flex items-center gap-2 border-b border-sand/20 pb-2"
                        ...
                        >
                            ...
                            <button
                                ...
                                className="text-bronze transition hover:text-sand"
                            >
                    ...
                    <nav className="flex gap-16">
                        <ul className="space-y-3">
                            {NAV.map((n) => (
                                <li key={n.href}>
                                    <a
                                        href={n.href}
                                        className="text-sand/80 transition hover:text-bronze"
                                    >
                                        {n.label}
                                    </a>
                                </li>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a href="#" className="text-sand/80 transition hover:text-bronze">
                                    Repairs
                                </a>
                            </li>
                            <li>
                ...
                <div className="mt-16 flex flex-col items-start justify-between gap-6 border-t border-sand/10 pt-8 md:flex-row md:items-center">
                    <span className="font-mono text-xs text-dune">
                        © {new Date().getFullYear()} {SITE.name} Studio. Made for the walk you did
                        not plan.
                    </span>
                    <div className="flex gap-4 text-sand">
                        ...
                        <a href="#" aria-label="Twitter" className="transition hover:text-bronze">
                            <FiTwitter size={20} />
                        </a>
                    </div>
                </div>
