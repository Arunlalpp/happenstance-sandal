            ...
            <div className="mx-auto grid max-w-[1600px] gap-16 md:grid-cols-[0.9fr_1.1fr]">
                ...
                <div className="md:sticky md:top-32 md:h-fit">
                    ...
                    <p className="mt-6 max-w-md text-dune">
                        Three ideas hold the Happenstance together. None of them are new — they are
                        just rarely all in the same pair.
                    </p>
                </div>
                    ...
                    <div className="space-y-32">
                        {STORY_BEATS.map((beat) => (
                            <div key={beat.index} className="story__beat">
                                ...
                                <h3 className="mt-4 font-display text-4xl text-sand md:text-5xl">
                                    {beat.title}
                                </h3>
                                <p className="mt-4 max-w-lg text-lg leading-relaxed text-dune">
                                    {beat.body}
                                </p>
                            </div>
                        ))}
