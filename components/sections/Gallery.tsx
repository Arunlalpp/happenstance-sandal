      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        <div className="grid auto-rows-[220px] grid-cols-2 gap-4 md:auto-rows-[280px] md:grid-cols-4">
          {GALLERY.map((g) => (
            ...
            >
              {/* Using <img> so it works before Next/Image config + your assets.
                  Swap to next/image once real files are in /public/images. */}
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={g.src}
                alt={g.alt}
                loading="lazy"
                className="gallery__img h-[115%] w-full scale-105 object-cover transition-transform duration-700 group-hover:scale-110"
              />
