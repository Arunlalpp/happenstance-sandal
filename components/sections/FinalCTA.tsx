...
export function FinalCTA() {
  return (
    <section id="cta" className="relative flex min-h-[90svh] items-center overflow-hidden bg-ink px-6 md:px-10">
      {/* ambient video wash behind the CTA */}
      <div className="absolute inset-0 opacity-40">
        <VideoSection src="/videos/story.mp4" poster="/images/story-poster.jpg" mode="inview" rounded={false} className="h-full w-full" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1600px]">
        ...
        <p className="mt-8 max-w-md text-lg text-dune">
          The first {SITE.name} run is 300 pairs, made to order. Reserve yours and
