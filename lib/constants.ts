...
/**
 * BUILD SEQUENCE
 * Ordered stills for the scroll-scrubbed "parts assemble into product"
 * moment (see components/ui/SandalBuild.tsx). First frame = most exploded,
 * last frame = fully landed. Drop new frames into /public/images/build.
 */
export const BUILD_FRAMES = [
  '/images/build/build-01.jpg',
  '/images/build/build-02.jpg',
  '/images/build/build-03.jpg',
  '/images/build/build-04.jpg',
] as const;
export const BUILD_ALT =
  'The Happenstance Sandal exploded into its component layers — straps, footbed, midsole, and outsole — settling together into the finished pair.';
...
export const FEATURES = [
  { title: 'Contour cork', body: 'A footbed that remembers where you have been.', tag: 'Comfort' },
  { title: 'Vegetable tan', body: 'Leather cured with bark, not chemicals. It ages, it does not wear out.', tag: 'Material' },
  { title: 'Blake stitch', body: 'A resolable construction borrowed from heritage shoemaking.', tag: 'Build' },
  { title: 'Grip lug outsole', body: 'Natural rubber that holds wet stone and warm sand alike.', tag: 'Traction' },
  { title: 'Adjustable throat', body: 'A single brass buckle dials the fit from loose to locked.', tag: 'Fit' },
  { title: 'Carbon neutral', body: 'Every pair offsets its own footprint, twice over.', tag: 'Planet' },
] as const;
